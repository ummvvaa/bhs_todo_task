...
//  2) задачи в статусе 'open' с дедлайном в ближайшие 24–48 часов;
...
const DUE_SOON_HOURS = 48 // окно ближайших дедлайнов
...
export function computeAttentionSignals(
  ...
  for (const t of tasks) {
    ...
    // Задачи open с дедлайном в ближайшие 24–48 ч (ещё не просроченные).
