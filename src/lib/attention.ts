...
//  2) задачи в статусе 'open' с дедлайном в ближайшие 24 часа;
...
const DUE_SOON_HOURS = 24 // окно ближайших дедлайнов
...
export function computeAttentionSignals(
  ...
  for (const t of tasks) {
    ...
    // Задачи open с дедлайном в ближайшие 24 ч (ещё не просроченные).
